...
FONT_7SEGMENT_S = load_font("fonts/7segment/7segment_23_monospace_digits.bdf")
FONT_7SEGMENT_M = load_font("fonts/7segment/7segment_66_monospace_digits_balanced_1.bdf")
