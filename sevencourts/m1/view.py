...
def draw(cnv: Canvas, state: PanelState, error=False):
...
def _draw_init_screen(cnv: Canvas, state: PanelState, error=False):
...
def _draw_idle_mode(cnv: Canvas, idle_info, time_now: str):
...
def _draw_standby_mode_indicator(cnv: Canvas, time_now: str):
...
def _draw_status_indicator(cnv: Canvas, color: Color):
